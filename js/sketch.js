...
async function preload() {
  mImgIn = loadImage("https://media.githubusercontent.com/media/PSAM-5020-2025F-A/5020-ColorFilter-Gradio/refs/heads/main/imgs/arara.jpg");
  let Gradio = await import("https://cdn.jsdelivr.net/npm/@gradio/client/dist/index.min.js");
  mClient = await Gradio.Client.connect("visualizedata/PSAM5020-ColorFilter-Gradio");
}
